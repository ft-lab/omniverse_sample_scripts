...
USDのすべてのベクトル・行列計算は、「Gf」(Graphics Foundations : https://openusd.org/release/api/gf_page_front.html )というモジュールにまとまっています。     
これは非常によく使う部分となります。      
...
これらのOmniverseのアクセスは"Omniverse Kit"の [kit-manual](https://docs.omniverse.nvidia.com/kit/docs/kit-manual/latest/guide/kit_overview.html) に情報があります。    
USD Composerの場合は、メインメニューの[Help]-[Developers Guide]からドキュメントにアクセスできます。    
...
"release"内の"extscache"にKitで提供されているExtensionが格納されています。      
